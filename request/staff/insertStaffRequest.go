 ...
 */
type InsertStaffRequest struct {
...
// Validate method
func (r *InsertStaffRequest) ValidateStaff() []map[string]string {
 ...
 */
func (r *InsertStaffRequest) ParseDates() (time.Time, error) {
...
/*
* InsertAllStaffRequest struct
*
*
* see the documentation about binding and validation here:
* https://blog.logrocket.com/gin-binding-in-go-a-tutorial-with-examples/#validating-date-time
 */
type InsertAllStaffRequest struct {
	InsertStaffRequest []InsertStaffRequest `json:"staff-data" binding:"required"`
}

// Validate method
func (r *InsertAllStaffRequest) ValidateAllStaff() []map[string]string {
	// Validate the struct
	err := res.ResponseMessage(req.Validate.Struct(r))
